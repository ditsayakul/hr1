	...
	$('#defaultForm').bootstrapValidator({
		...
		fields: {
			...
			mobile: {
				validators: {
					...
					stringLength: {
						min: 9,
						max: 50,
						message: 'The mobile must be more than 9 digits long'
					}
				}
			},
			color: {
			...
			ages: {
				...
				validators: {
					notEmpty: {
						message: 'The prefix is required and can\'t be empty'
					}
				}
			},
			prefix: {
				...
				validators: {
					...
					regexp: {
						regexp: /^[ก-๙เ_\.]+$/,
						message: 'The firstname can only consist of Thai alphabetical'
					}
				}
			},
			lastname_th: {
				validators: {
					...
					regexp: {
						regexp: /^[ก-๙เ_\.]+$/,
						message: 'The lastname can only consist of Thai alphabetical'
					}
				}
			},
			firstname_en: {
			...
			idcardnumber: {
				validators: {
					...
					stringLength: {
						min: 13,
						max: 13,
						message: 'The id card number must be equal 13 digits long'
					}
				}
			}
		}
